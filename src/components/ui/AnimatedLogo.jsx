...
const AnimatedLogo = ({ startAnimation }) => {
  return (
    <>
      <svg
        version="1.1"
      ...
      >
        <g className="feat">
          <g className={startAnimation ? "sub_one" : ""}>
            <path
              className="st0"
              d="M681.5,231.3c0.2-12,13-21.2,24.4-18.2c9.8,2,16.5,12.1,15.5,22c-0.8,138.7-1.3,277.4-2.2,416.1
          ...
          <g className={startAnimation ? "dots" : ""}>
      ...
      <style jsx>{`
        ...
        .sub_one path {
          ...
          animation: offset 3s 1.5s linear forwards, fill 1.5s 4s ease forwards;
        }
        ...
        .dots circle:nth-of-type(1) {
          opacity: 0;
          transform: translate(0px, 100px);
          animation: eff_one 0.5s 4.5s ease forwards;
        }
        ...
        .dots circle:nth-of-type(2) {
          opacity: 0;
          transform: translate(0px, -100px);
          animation: eff_two 0.5s 4.5s ease forwards;
        }
        ...
        .dots circle:nth-of-type(3) {
          opacity: 0;
          transform: translate(-100px, 0px);
          animation: eff_three 0.5s 4.5s ease forwards;
        }
        ...
        .dots circle:nth-of-type(4) {
          opacity: 0;
          transform: translate(100px, 0px);
          animation: eff_four 0.5s 4.5s ease forwards;
        }
        ...
        .dots circle:nth-of-type(5) {
          opacity: 0;
          transform: translate(-100px, -100px);
          animation: eff_five 0.5s 4.7s ease forwards;
        }
        ...
        .dots circle:nth-of-type(6) {
          opacity: 0;
          transform: translate(-100px, 100px);
          animation: eff_six 0.5s 4.7s ease forwards;
        }
        ...
        .dots circle:nth-of-type(7) {
          opacity: 0;
          transform: translate(100px, 100px);
          animation: eff_seven 0.5s 4.7s ease forwards;
        }
        ...
        .dots circle:nth-of-type(8) {
          opacity: 0;
          transform: translate(100px, -100px);
          animation: eff_eight 0.5s 4.7s ease forwards;
        }
      `}</style>
    </>
  );
