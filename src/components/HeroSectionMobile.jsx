...
const HeroSection = memo(() => {
  ...
  // Detect when stats section enters viewport for animations
  useEffect(() => {
      ...
      >
        <div className="container mx-auto px-4 relative z-10 w-full">
          ...
          <div className="text-center mb-16">
            <h2 className="text-5xl md:text-6xl font-bold mb-5 relative overflow-hidden tracking-[0.3em]">
  ...
  return (
    <div className="relative w-screen overflow-x-hidden bg-zinc-900">
      ...
      {/* Content Container - Normal stacking layout */}
      <div className="relative z-10">
        ...
        {/* Slide 2: Stats Content - Normal scroll section */}
        <div
