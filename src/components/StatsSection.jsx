...
const StatsSection = memo(() => {
      ...
      tl.to(split.chars, {
        ...
        onUpdate: function () {
          ...
          this.targets().forEach((char) => {
            char.style.filter = `blur(${char.style.getPropertyValue(
              "--blur"
            )})`;
          });
        },
  ...
  return (
    <section
      ...
      style={{
        background: `
              radial-gradient(circle at center, rgb(0, 0, 0) 0px, rgba(1, 1, 1, 0) 100%), linear-gradient(#fbe9cd, rgba(0, 0, 0, 0.94) 80%)
                `,
      }}
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div
          className="w-full p-10 rounded-lg  "
          // style={{
        ...
        >
          <div
            ref={statsRef}
            className="flex flex-col md:flex-row gap-32 max-w-screen mx-auto"
          >
