    ...
    <div ref={containerRef} className="mb-12 sm:mb-16 md:mb-20 overflow-hidden">
      <div className="space-y-6 sm:space-y-8 md:space-y-10 max-w-5xl mx-auto px-4 text-left">
        <div className="flex gap-3 sm:gap-4">
          <span className="text-base sm:text-lg md:text-xl lg:text-2xl text-white/90 font-chinese font-normal flex-shrink-0">
            •
          </span>
          <div className="space-y-2 sm:space-y-3">
            <p
              ref={line1Ref}
              className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed text-white/90 font-chinese font-normal tracking-wide"
            >
              我们不止是「咨询顾问」,而是「共建者」
            </p>
            <p
              ref={line2Ref}
              className="text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed text-white/75 font-chinese font-light tracking-wide"
            >
