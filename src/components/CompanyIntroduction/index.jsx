...
const CompanyIntroduction = memo(() => {
  ...
  useScrollAnimations(textContainerRef);

  return (
    <div ref={contentRef} className="text-center min-h-screen relative flex items-center justify-center font-sans overflow-hidden">
