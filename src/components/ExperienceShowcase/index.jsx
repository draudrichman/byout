...
const ExperienceShowcase = memo(() => {
  ...
  return (
    <div id="channel-layout" className="py-20 px-10 text-center bg-gradient-to-b from-transparent via-black/50 to-black" style={{backgroundImage: 'linear-gradient(to bottom, transparent 0%, black 33%, black 100%) ', transition: '0s', }}>
