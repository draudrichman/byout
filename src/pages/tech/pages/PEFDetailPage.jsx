...
function PEFDetailPage() {
  ...
  const handleBack = () => {
    navigate("/tech", { state: { targetSection: "pef", fromDetailPage: true } });
  };
    ...
    <div className="detail-page-container">
      ...
      <main className="detail-content page-container">
        ...
        <div className="application-text">
          <strong>鲜到鲜应用场景：</strong>
          DIY冰沙饮、冻眠一级鲜、无水快解冻、纳米晶鲜切… …全冷链赋能！
        </div>
        ...
        <div className="app-scene-row-2">
          ...
          <div className="app-scene-item"></div>
        </div>
        ...
        <div className="figure-caption">
          -2-CIF真空L / -2-C非真空a / -2-C非真空b / -2-C非空 / -4-C非真空 /
          -4-C非真空a / -4-C非真空b / -4-C真空L / -4-C真空a / -4-C真空b
        </div>

        <div className="conclusion-box">
          <p>
            -4°C
            真空组的羊肉和所有牛肉样品在贮藏期结束后保存软鲜态，结论为一级鲜肉标准，表明冰温保鲜处理的牛羊肉贮藏
            15d 也能保持食品品质。
          </p>
        </div>
        ...
        <p className="tech-desc">
          1、送风方式：我司将3代微晶升级后，送风方式由顶部多孔送风改为后部直吹送风。
        </p>
        ...
        <p className="tech-desc">
          2、控温方式：我司为满足 80% 负载和 25h 拉温要求，采用拉温段 -
          回温段交替控温逻辑，单点温度低至
          -8°C，加剧过冻现象和温度波动问题。（空载测试）。竞品温度更均匀。
        </p>
        ...
        <h2 className="final-section-title">
          鲜到鲜 VS 海尔恒磁 VS 美的微晶：鲜到鲜技术才能实现 15 天保持一级鲜
        </h2>

        <div className="test-points">
          <p>
            1、测试标准：测试标准负载量更大。各自标准工况下，恒磁保鲜周期10天，微晶保鲜周期7天，均与宣传一致；
          </p>
          <p>
            2、测试效果：少载、半载场景下恒磁效果更优（10天肉色均匀无过冻），满载场景下微晶优势明显，无血水，保鲜期7天；恒磁底部血水较多，保鲜期仅5天
          </p>
        </div>
        ...
        <div className="analysis-box">
          ...
          <p>
            1、竞品测试标准更接近实际用户场景，我司测试标准要求 80%
            负载为极端状态。竞品标准有参考价值。
          </p>
          <p>
            2、采用拉温段-回温段交替控温逻辑，在降温速率优势明显，但拉温段温度低，易造成局部食材过冻；海尔恒磁采用恒温控温逻辑，温度整体控制较均匀且稳定
          </p>
        </div>
          ...
          <tbody>
            <tr>
              ...
              <td>
                保鲜期：10-14天
                <br />
                状态：存在部分肉过冻、暗红，14天轻微异味
              </td>
              <td>
                保鲜期：7天 标准工况
                <br />
                状态：底部有少量血水，风口位置有过冻现象
              </td>
            </tr>
            <tr>
              <td>海尔恒磁</td>
