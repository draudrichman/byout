...
const ScrollCards: React.FC = () => {
    ...
    useEffect(() => {
        // Prevent running GSAP registration and ScrollTrigger setup during SSR.
        // Dynamically import the plugin on the client and register it there.
        let mm: any = null;
        ...
        (async () => {
            ...
            // Dynamically import the ScrollTrigger plugin and register it client-side
            const mod = await import('gsap/ScrollTrigger');
            ScrollTriggerModule = mod?.ScrollTrigger ?? mod;
            try {
                gsap.registerPlugin(ScrollTriggerModule);
            } catch (e) {
                // If registerPlugin throws (rare), continue — registration is idempotent
            }
        ...
        return () => {
            if (mm) mm.revert();
            if (ScrollTriggerModule && typeof ScrollTriggerModule.getAll === 'function') {
